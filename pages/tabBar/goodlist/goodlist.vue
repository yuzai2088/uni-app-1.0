	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="left">
				<view @tap="handleCategory(index)" :class="{'on':index==showGoodListIndex}" class="row" v-for="(category,index) in goodsList"
				 :key="index">
					<view class="text">
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category,index) in goodsList" :key="category.id" v-show="index===showGoodListIndex">
					<view class="banner">
