<template>
	<view class="">
		<!-- 结算列表 -->
		<view class="buy-list">
			<view class="row" v-for="(item,index) in accountList" :key="index">
			...
			uni.getStorage({
				...
				success: (res) => {
					...
					for (let i = 0; i < this.accountList.length; i++) {
						this.goodsPrice = this.goodsPrice + (this.accountList[i].number * this.accountList[i].price)
					}
					// 支付金额
